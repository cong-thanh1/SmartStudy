...
| Isolation dữ liệu hai user | PASS (Chromium) |
| Rate limit / resilience | Chưa chạy browser end-to-end trong đợt này |
...
| I1 | Hai user không thấy tài liệu của nhau | Chromium | PASS |
...
![I1 — dashboard tách biệt của user A](test-evidence/isolation/H1-user-a.png)
...
- Chưa có browser E2E cho rate limit 200 request/phút và resilience khi tắt MinIO/Redis/network.
